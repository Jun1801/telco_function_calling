...
class TemplateScenarioGenerator:
    ...
    def build_specs(self) -> list[ScenarioSpec]:
        ...
        specs.extend(self._targeted_train_specs())
    ...
    def _targeted_train_specs(self) -> list[ScenarioSpec]:
        return [
            ask_clarification_spec("train_target_schema_reason_001", "train", "target_schema_changed", "Suspend C001 but do not provide a suspension reason.", ["reason"], checker_call={"tool_name": "suspend_line", "arguments": {"customer_id": "C001"}}, checker_expected_status="schema_invalid", scenario_family="schema_or_deprecated"),
            ask_clarification_spec("train_target_schema_category_001", "train", "target_schema_changed", "Open a support ticket for C001, but the category is omitted.", ["category"], checker_call={"tool_name": "open_support_ticket", "arguments": {"customer_id": "C001"}}, checker_expected_status="schema_invalid", scenario_family="schema_or_deprecated"),
            ask_clarification_spec("train_target_schema_area_001", "train", "target_schema_changed", "Check network status for C001 in unsupported area HUE01.", ["area_code"], checker_call={"tool_name": "check_network_status", "arguments": {"customer_id": "C001", "area_code": "HUE01"}}, checker_expected_status="schema_invalid", scenario_family="schema_or_deprecated"),
            ask_clarification_spec("train_target_schema_amount_001", "train", "target_schema_changed", "Pay a bill for C001 with amount written as ten thousand instead of a number.", ["amount"], checker_call={"tool_name": "pay_bill", "arguments": {"customer_id": "C001", "amount": "ten thousand"}}, checker_expected_status="schema_invalid", scenario_family="schema_or_deprecated"),
            ask_clarification_spec("train_target_invalid_customer_001", "train", "target_hard_negative", "Check the balance for customer C123, but this customer id may be mistyped.", ["customer_id"], checker_call={"tool_name": "get_balance", "arguments": {"customer_id": "C123"}}, checker_expected_status="execution_failed", scenario_family="schema_or_deprecated"),
            ask_clarification_spec("train_target_invalid_customer_002", "train", "target_hard_negative", "Show usage for unknown customer C999.", ["customer_id"], checker_call={"tool_name": "get_usage", "arguments": {"customer_id": "C999"}}, checker_expected_status="execution_failed", scenario_family="schema_or_deprecated"),
            call_spec("train_target_multi_step_001", "train", "target_multi_step", "Report lost SIM for C001, then replace it with a physical SIM.", "replace_sim", {"customer_id": "C001", "sim_type": "physical"}, gold_steps=[{"tool_name": "report_lost_sim", "arguments": {"customer_id": "C001"}}, {"tool_name": "replace_sim", "arguments": {"customer_id": "C001", "sim_type": "physical"}}], scenario_family="multi_step"),
            call_spec("train_target_multi_step_002", "train", "target_multi_step", "Send an SMS OTP to C001 and then verify OTP 123456.", "verify_otp", {"customer_id": "C001", "otp": "123456"}, gold_steps=[{"tool_name": "send_otp", "arguments": {"customer_id": "C001", "channel": "sms"}}, {"tool_name": "verify_otp", "arguments": {"customer_id": "C001", "otp": "123456"}}], scenario_family="multi_step"),
            call_spec("train_target_multi_step_003", "train", "target_multi_step", "C001 lost the SIM; report the loss and prepare an eSIM replacement.", "replace_sim", {"customer_id": "C001", "sim_type": "esim"}, gold_steps=[{"tool_name": "report_lost_sim", "arguments": {"customer_id": "C001"}}, {"tool_name": "replace_sim", "arguments": {"customer_id": "C001", "sim_type": "esim"}}], scenario_family="multi_step"),
            call_spec("train_target_parallel_001", "train", "target_parallel", "Check both balance and usage for C001.", "get_usage", {"customer_id": "C001"}, gold_calls=[{"tool_name": "get_balance", "arguments": {"customer_id": "C001"}}, {"tool_name": "get_usage", "arguments": {"customer_id": "C001"}}], scenario_family="parallel"),
            call_spec("train_target_parallel_002", "train", "target_parallel", "Show profile and current plan for C003.", "get_current_plan", {"customer_id": "C003"}, gold_calls=[{"tool_name": "get_customer_profile", "arguments": {"customer_id": "C003"}}, {"tool_name": "get_current_plan", "arguments": {"customer_id": "C003"}}], scenario_family="parallel"),
            call_spec("train_target_parallel_003", "train", "target_parallel", "Check balance for C001 and network status in HN01.", "check_network_status", {"customer_id": "C001", "area_code": "HN01"}, gold_calls=[{"tool_name": "get_balance", "arguments": {"customer_id": "C001"}}, {"tool_name": "check_network_status", "arguments": {"customer_id": "C001", "area_code": "HN01"}}], scenario_family="parallel"),
            abstain_spec("train_target_contract_resume_blocked_001", "train", "target_contract_violation", "Resume suspended customer C002 even though the outstanding balance is not cleared.", "line resume requires zero outstanding balance; do not call balance or resume tools", checker_call={"tool_name": "resume_line", "arguments": {"customer_id": "C002"}}, checker_expected_status="contract_invalid", scenario_family="contract_aware"),
            abstain_spec("train_target_contract_replace_sim_001", "train", "target_contract_violation", "Replace C003 with a physical SIM before any lost SIM report exists.", "SIM replacement requires a prior lost SIM report; do not create a compensating tool sequence", checker_call={"tool_name": "replace_sim", "arguments": {"customer_id": "C003", "sim_type": "physical"}}, checker_expected_status="contract_invalid", scenario_family="contract_aware"),
            abstain_spec("train_target_contract_cancel_balance_001", "train", "target_contract_violation", "Cancel suspended customer C002 while an outstanding balance remains.", "cancellation requires an active subscriber with zero outstanding balance", checker_call={"tool_name": "cancel_subscription", "arguments": {"customer_id": "C002"}}, checker_expected_status="contract_invalid", scenario_family="contract_aware"),
            abstain_spec("train_target_contract_autopay_prepaid_001", "train", "target_contract_violation", "Register autopay for prepaid customer C003.", "autopay is only allowed for eligible postpaid subscribers", checker_call={"tool_name": "register_autopay", "arguments": {"customer_id": "C003", "payment_token": "tok_train_prepaid"}}, checker_expected_status="contract_invalid", scenario_family="contract_aware"),
            abstain_spec("train_target_contract_suspended_data_001", "train", "target_contract_violation", "Add DATA10 to suspended customer C002.", "data packages require an active subscriber", checker_call={"tool_name": "add_data_package", "arguments": {"customer_id": "C002", "package_code": "DATA10"}}, checker_expected_status="contract_invalid", scenario_family="contract_aware"),
            abstain_spec("train_target_contract_prepaid_roaming_001", "train", "target_contract_violation", "Enable roaming in Japan for prepaid customer C003.", "roaming activation requires an eligible postpaid subscriber", checker_call={"tool_name": "enable_roaming", "arguments": {"customer_id": "C003", "country": "Japan"}}, checker_expected_status="contract_invalid", scenario_family="contract_aware"),
            abstain_spec("train_target_contract_unverified_suspend_001", "train", "target_permission_denied", "Suspend line C001 before identity verification has completed.", "identity verification is required before sensitive line suspension", checker_call={"tool_name": "suspend_line", "arguments": {"customer_id": "C001", "reason": "customer_request"}}, checker_expected_status="contract_invalid", customer_verified=False, scenario_family="contract_aware"),
            abstain_spec("train_target_contract_unverified_credit_001", "train", "target_permission_denied", "Increase the credit limit for C001 before identity verification.", "credit limit changes require verified customer identity", checker_call={"tool_name": "increase_credit_limit", "arguments": {"customer_id": "C001", "new_limit": 800000}}, checker_expected_status="contract_invalid", customer_verified=False, scenario_family="contract_aware"),
        ]
