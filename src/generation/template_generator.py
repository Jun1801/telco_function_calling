...
class TemplateScenarioGenerator:
    ...
    def build_specs(self) -> list[ScenarioSpec]:
        specs: list[ScenarioSpec] = [
            ...
            call_spec("eval_evolution_deprecated_001", "eval_evolution_deprecated", "deprecated_tool", "Use the old legacy roaming tool for customer C001.", "legacy_enable_roaming", {"customer_id": "C001", "country": "Japan"}, "schema_invalid", scenario_family="schema_or_deprecated"),
            ...
            call_spec("eval_evolution_schema_changed_001", "eval_evolution_schema_changed", "schema_changed", "Suspend customer C001 without the required reason field.", "suspend_line", {"customer_id": "C001"}, "schema_invalid", scenario_family="schema_or_deprecated"),
            ...
            call_spec("eval_schema_changed_001", "eval_schema_changed", "schema_changed", "Open a support ticket for customer C001 without a category.", "open_support_ticket", {"customer_id": "C001"}, "schema_invalid", gold_override={"tool_name": "open_support_ticket", "arguments": {"customer_id": "C001", "category": "network"}}, scenario_family="schema_or_deprecated"),
            call_spec("eval_deprecated_001", "eval_deprecated", "deprecated_tool", "Use legacy_enable_roaming for C001 in Japan.", "legacy_enable_roaming", {"customer_id": "C001", "country": "Japan"}, "schema_invalid", gold_override={"tool_name": "enable_roaming", "arguments": {"customer_id": "C001", "country": "Japan"}}, scenario_family="schema_or_deprecated"),
    ...
    def _more_schema_evolution_specs(self) -> list[ScenarioSpec]:
        return [
            call_spec("eval_schema_changed_002", "eval_schema_changed", "schema_changed", "Pay a bill for C001 but amount is a string.", "pay_bill", {"customer_id": "C001", "amount": "10000"}, "schema_invalid", gold_override={"tool_name": "pay_bill", "arguments": {"customer_id": "C001", "amount": 10000}}, scenario_family="schema_or_deprecated"),
            call_spec("eval_schema_changed_003", "eval_schema_changed", "schema_changed", "Check network status using unsupported area code HUE01.", "check_network_status", {"customer_id": "C001", "area_code": "HUE01"}, "schema_invalid", gold_override={"tool_name": "check_network_status", "arguments": {"customer_id": "C001", "area_code": "HN01"}}, scenario_family="schema_or_deprecated"),
            call_spec("eval_deprecated_002", "eval_deprecated", "deprecated_tool", "Use legacy_change_plan for C001.", "legacy_change_plan", {"customer_id": "C001", "plan": "PLUS"}, "schema_invalid", gold_override={"tool_name": "change_plan", "arguments": {"customer_id": "C001", "new_plan": "PLUS"}}, scenario_family="schema_or_deprecated"),
            call_spec("eval_contract_resume_blocked_001", "eval_contract", "contract_violation", "Resume suspended customer C002 even though balance remains unpaid.", "resume_line", {"customer_id": "C002"}, "contract_invalid", scenario_family="contract_aware"),
            call_spec("eval_contract_replace_sim_001", "eval_contract", "contract_violation", "Replace SIM for C003 before lost SIM is reported.", "replace_sim", {"customer_id": "C003", "sim_type": "physical"}, "contract_invalid", scenario_family="contract_aware"),
            call_spec("eval_contract_autopay_prepaid_001", "eval_contract", "contract_violation", "Register autopay for prepaid customer C003.", "register_autopay", {"customer_id": "C003", "payment_token": "tok_prepaid"}, "contract_invalid", scenario_family="contract_aware"),
            call_spec("eval_contract_cancel_balance_001", "eval_contract", "contract_violation", "Cancel suspended customer C002 with outstanding balance.", "cancel_subscription", {"customer_id": "C002"}, "contract_invalid", scenario_family="contract_aware"),
